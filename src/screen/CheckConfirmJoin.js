...
import CheckConfirmJoinSVG from '../resource/svg/CheckConfirmJoin.svg'
import CheckConfirmJoin_SubSVG from '../resource/svg/CheckConfirmJoin_Sub.svg'
import ShapeSVG from '../resource/svg/Shape.svg'
                            ...
                            <View>
                                <TouchableOpacity>
                                    <View style={[{backgroundColor:'#16A9CF', height:55, width:(screenwidth - 32), borderRadius:15, justifyContent:'center'}]}>
                                        <Text style={[{fontStyle:'normal', textfontFamily:'Quicksand-Bold', lineHeight:22, fontSize:18, fontWeight:"700", color:'#FFFFFF', textAlign:'center'}]}>Enter Verification Code</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
...
export default CheckConfirmJoin;
